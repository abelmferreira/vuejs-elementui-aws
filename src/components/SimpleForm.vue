...
<template>
  <div :style="style.form">
    <div :style="style.inputRow" v-for="field in fields" :key="field.name">
...
export default {
  ...
  methods: {
    load() {
      Storage.get(this.path, { download: true, level: 'private' })
        .then(data => {
    ...
    save() {
      ...
      Storage.put(this.path, data, { contentType: 'application/json', level: 'private'  })
